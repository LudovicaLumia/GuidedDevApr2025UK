namespace Terrasoft.Configuration
{
	...
	public class UsrRealtyEventsSchema : Terrasoft.Core.SourceCodeSchema
	{
		...
		protected override void InitializeProperties() {
			...
			UId = new Guid("110a804c-9b4c-4529-88e2-df74d900b2c0");
		...
		protected virtual SchemaLocalizableString CreateValueIsTooBigLocalizableString() {
			SchemaLocalizableString localizableString = new SchemaLocalizableString() {
				UId = new Guid("fd61c851-ae2b-180a-17a4-5a3c223d54c0"),
				Name = "ValueIsTooBig",
				CreatedInPackageId = new Guid("c1bdffac-d8d2-4b8d-9db9-1f6e012fbead"),
				CreatedInSchemaUId = new Guid("110a804c-9b4c-4529-88e2-df74d900b2c0"),
				ModifiedInSchemaUId = new Guid("110a804c-9b4c-4529-88e2-df74d900b2c0")
			};
		...
		public override void GetParentRealUIds(Collection<Guid> realUIds) {
			...
			realUIds.Add(new Guid("110a804c-9b4c-4529-88e2-df74d900b2c0"));
		}
